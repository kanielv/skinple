  ...
  return (
    <form action={submitQuiz}>
      ...
      <div>
        ...
        <label htmlFor='itchy'>
          My skin is oily in some areas (like the T-zone) but dry in others.
        </label>
      </div>
      <div>
      ...
      <div>
        ...
        <label htmlFor='average'>
          Average (neither very humid nor very dry)
        </label>
      </div>
      <div>
      ...
      <label>
        Have you ever experienced irritation or redness after using skincare
        products?
      </label>
      <div>
      ...
      <label>
        If yes, what type of reaction did you experience? (Select all that
        apply)
      </label>
      <div>
      ...
      <div>
        <label htmlFor='reactionDetails'>
          If other, please describe the reaction:{' '}
        </label>
        <input
          type='text'
          id='reactionDetails'
      ...
      <hr></hr>
      <label htmlFor='allergy-search'>
        Which skincare ingredients do you want to avoid due to allergies or
        sensitivities? (E.g. fragrances - eugenol, preservatives - parabens,
        etc.){' '}
      </label>
      <input
        id='allergy-search'
      ...
      {query && (
        <ul className='max-h-40 overflow-y-auto border bg-white'>
